...
#' }
#' @export
carrousel <- function(number_sections = FALSE,
                 fig_width = 7,
                 fig_height = 5,
  ...
  dep <- htmltools::htmlDependency("carrousel", "0.1",
                                   src = system.file("rmarkdown", "templates", "carrousel", "resources",
                                                     package = "ddjrmd"),
                                   stylesheet=c("carrousel.css"),
                                   script = "carrousel.js")
  ...
  args <- c(args, "--template",
            rmarkdown::pandoc_path_arg(system.file("rmarkdown", "templates", "carrousel", "base.html",
                                                   package = "ddjrmd")))
