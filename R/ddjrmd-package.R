...
#'
#' \itemize{
#' \item \code{bulma} (\code{output: ddjrmd::bulma}) uses the Bulma CSS
...
#'
#' \item \code{skeleton} (\code{output: ddjrmd::skeleton}) or
#' \code{default} (\code{output:ddjrmd::default}) uses the Skeleton CSS
#' framework and also has optional \code{navlink} YAML
#' header element as well as support for limited OpenGraph header elements
#' (see the example Rmd) which will be used in header of the generated file.
#'
#' \item \code{kube} (\code{output: ddjrmd::kube}) uses the Kube CSS framework
#'  (contributed by Kieran Healy)
#'
#' \item \code{minimal} (\code{output: ddjrmd::minimal}) uses no CSS framework and
#' only uses the `title` YAML header element.
#'
#' \item \code{hugo} (\code{output: ddjrmd::hugo}) produces markdown suitable
...
#' @name ddjrmd
#' @docType package
#' @author datasketch (info@datasketch.co)
