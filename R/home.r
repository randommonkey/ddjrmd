...
#' }
#' @export
home <- function(number_sections = FALSE,
                     fig_width = 7,
                     fig_height = 5,
  ...
  dep <- htmltools::htmlDependency("home", "0.1",
                                   src = system.file("rmarkdown", "templates", "home", "resources",
                                               package = "ddjrmd"),
                                   stylesheet=c("home.css"),
                                   script = "home.js")
  ...
  args <- c(args, "--template",
            rmarkdown::pandoc_path_arg(system.file("rmarkdown", "templates", "home", "base.html",
                                                   package = "ddjrmd")))
